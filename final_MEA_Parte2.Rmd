...
Teniendo en cuenta que se cuenta con las salidas CV y CVdif, se ponen a
consideración cuatro modelos considerando combinaciones entre las salidas y las
variables en vairación porcentual anual (dif). Al considerar cuán interpretables
pueden ser los resultados se opta por el modelo que considera los costos de
venta en variación porcentual anual y las variables explicativas de igual modo.
```{r}
